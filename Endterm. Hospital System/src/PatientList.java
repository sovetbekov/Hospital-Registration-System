...
public class PatientList {
        public static void displayPatientData() {
            ...
            String[] columnNames = {"name", "surname", "gender", "disease", "doctor", "city", "email", "password", "confirmpassword", "order_id"};
            ...
            try {
                ...
                // displaying patients
                PreparedStatement list = connection.prepareStatement("select * from patient");
                ...
                while (rs.next()) {
                    ...
                    model.addRow(new Object[]{firstname, secondname, gender, disease, doctor, city, email, password, confirm, order_id});
